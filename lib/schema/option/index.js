...
exports.optionText = exports.optionMatches = exports.findBestMatchingNumericOption = exports.optionSortValueForDisplay = exports.optionSchema = exports.optionSchemas = void 0;
...
function findBestMatchingNumericOption(optionsById, data) {
    const numericOptionsById = (0, lodash_1.pickBy)(optionsById, numeric_1.optionIsNumericOption);
    const optionsArray = Object.keys(numericOptionsById).map(id => (Object.assign({ id }, numericOptionsById[id])));
...
exports.findBestMatchingNumericOption = findBestMatchingNumericOption;
