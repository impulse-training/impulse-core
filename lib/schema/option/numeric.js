...
exports.numericOptionText = exports.optionIsNumericOption = exports.numericOptionSchema = void 0;
...
exports.numericOptionSchema = (0, base_1.optionValueBaseSchema)('numeric')
    .shape({
...
function numericOptionText(option) {
    ...
    return (0, lodash_1.compact)([unit, formatter(value)]).join(' ');
}
