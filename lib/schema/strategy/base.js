...
function strategyValueBaseSchema(type, schema) {
    return yup.object({
        ...
        docRef: firestore_1.documentReferenceSchema.required(),
        docData: schema,
        ordinal: yup.number().required(),
    });
}
exports.strategyValueBaseSchema = strategyValueBaseSchema;
