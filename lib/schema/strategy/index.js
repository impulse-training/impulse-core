...
const folderStrategy_1 = require("./folderStrategy");
const tacticStrategy_1 = require("./tacticStrategy");
__exportStar(require("./folderStrategy"), exports);
__exportStar(require("./tacticStrategy"), exports);
// Utility to dynamically select the correct schema based on the strategy type
exports.strategySchemas = {
    folder: folderStrategy_1.folderStrategySchema,
    tactic: tacticStrategy_1.tacticStrategySchema,
};
