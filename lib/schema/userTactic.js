...
exports.userTacticSchema = yup.object({
    ...
    tacticDoc: firestore_1.documentReferenceSchema.required(),
    allBehaviors: yup.boolean().required(),
    behaviorDocs: yup.array().of(firestore_1.documentReferenceSchema.required()),
    routineDocs: yup.array().of(firestore_1.documentReferenceSchema.required()),
});
