...
exports.tacticSchemas = {
    phone: phone_1.phoneTacticSchema,
    audio: audio_1.audioTacticSchema,
    video: video_1.videoTacticSchema,
    question: question_1.questionTacticSchema,
    folder: folder_1.folderTacticSchema,
    'measure-time': measure_1.measureTimeTacticSchema,
    'measure-slider': measure_1.measureSliderTacticSchema,
    'measure-counter': measure_1.measureCounterTacticSchema,
    breathe: breathe_1.breatheTacticSchema,
    steps: steps_1.stepsTacticSchema,
    task: task_1.taskTacticSchema,
    emotions: emotions_1.emotionsTacticSchema,
    'urge-surfing': urgeSurfing_1.urgeSurfingTacticSchema,
};
