...
exports.dateSummarySchema = void 0;
...
const logSummarySchema = yup.object({
    ...
    tacticSummariesById: (0, objectOf_1.objectOf)(tacticSummarySchema),
});
exports.dateSummarySchema = yup.object({
    createdAt: timestamp_1.optionalTimestampSchema,
    updatedAt: timestamp_1.optionalTimestampSchema,
    profileId: yup.string().required(),
    dateString: yup.string().required(),
    logSummariesById: (0, objectOf_1.objectOf)(logSummarySchema),
});
