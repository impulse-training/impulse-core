...
exports.folderMembershipSchema = void 0;
const yup = __importStar(require("yup"));
const folder_1 = require("./folder");
const firestore_1 = require("./utils/firestore");
const objectOf_1 = require("./utils/objectOf");
const timestamp_1 = require("./utils/timestamp");
exports.folderMembershipSchema = yup.object().shape({
    createdAt: timestamp_1.optionalTimestampSchema,
    updatedAt: timestamp_1.optionalTimestampSchema,
    folderRef: firestore_1.documentReferenceSchema.required(),
    folderData: folder_1.folderSchema,
