...
exports.gameplanSchema = yup.object().shape({
    ...
    main: (0, objectOf_1.objectOf)(strategy_1.strategySchema),
    setback: (0, objectOf_1.objectOf)(strategy_1.strategySchema),
    success: (0, objectOf_1.objectOf)(strategy_1.strategySchema),
    // A record of the tactics that are used to measure the outcome, by patternId
    measureTacticIds: (0, objectOf_1.objectOf)(yup.string().required()),
