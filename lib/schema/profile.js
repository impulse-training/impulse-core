...
exports.profileSchema = yup.object().shape({
    ...
    impulseTacticIdsByPatternId: (0, objectOf_1.objectOf)(array_1.requiredStringArray),
    scheduledStrategies: yup.array(time_1.timeStrategySchema).required(),
    locationStrategies: yup.array(location_1.locationStrategySchema).required(),
