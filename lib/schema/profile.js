...
const impulse_1 = require("./strategy/impulse");
const location_1 = require("./strategy/location");
const time_1 = require("./strategy/time");
...
exports.profileSchema = yup.object().shape({
    ...
    impulseStrategiesByPatternId: (0, objectOf_1.objectOf)((0, objectOf_1.objectOf)(impulse_1.impulseStrategySchema)),
    scheduledStrategies: (0, objectOf_1.objectOf)(time_1.timeStrategySchema),
    locationStrategies: (0, objectOf_1.objectOf)(location_1.locationStrategySchema),
