...
const routines_1 = require("./utils/routines");
...
exports.profileSchema = yup.object().shape({
    ...
    timeStrategies: (0, objectOf_1.optionalObjectOf)(routines_1.timeStrategySchema.required()),
    locationStrategies: (0, objectOf_1.optionalObjectOf)(routines_1.locationStrategySchema.required()),
