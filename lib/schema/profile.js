...
exports.profileSchema = yup.object().shape({
    ...
    impulseStrategiesByPatternId: (0, objectOf_1.objectOf)(yup.array(strategy_1.strategySchema)),
    scheduledStrategies: yup.array(time_1.timeStrategySchema.required()).required(),
    locationStrategies: yup.array(location_1.locationStrategySchema.required()).required(),
