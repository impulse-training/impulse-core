...
exports.LONG_DAYS = exports.SHORT_DAYS = exports.gameplanSchema = exports.locationRoutineSchema = exports.timeRoutineSchema = exports.strategySchema = void 0;
...
exports.timeRoutineSchema = exports.strategySchema.shape({
    weekdays: yup
        .array()
        .of(yup
        .number()
...
exports.locationRoutineSchema = exports.strategySchema.shape({
...
exports.gameplanSchema = yup.object().shape({
    ...
    impulse: (0, objectOf_1.objectOf)(exports.strategySchema),
    impulseDebrief: (0, objectOf_1.objectOf)(exports.strategySchema),
    // Daily recap
    recap: exports.timeRoutineSchema.optional().default(undefined),
    // These are the strategies for scheduled times of day...
    time: (0, objectOf_1.optionalObjectOf)(exports.timeRoutineSchema.required()),
    // ...Or when arriving at or leaving a location
    location: (0, objectOf_1.optionalObjectOf)(exports.locationRoutineSchema.required()),
