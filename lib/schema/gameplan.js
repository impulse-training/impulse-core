...
exports.LONG_DAYS = exports.SHORT_DAYS = exports.gameplanSchema = exports.locationRoutineSchema = exports.timeRoutineSchema = exports.strategy = void 0;
...
exports.timeRoutineSchema = exports.strategy.shape({
    weekdays: yup
        .array()
        .of(yup
        .number()
...
exports.locationRoutineSchema = exports.strategy.shape({
...
exports.gameplanSchema = yup.object().shape({
    ...
    dayDebrief: yup.lazy(value => (value ? exports.timeRoutineSchema : yup.mixed())),
