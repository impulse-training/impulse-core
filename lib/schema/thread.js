...
exports.threadSchema = exports.aiSuggestionsById = exports.agentType = exports.outcome = exports.AgentType = void 0;
...
exports.aiSuggestionsById = (0, objectOf_1.objectOf)(yup.object({
    tactic: tactic_1.tacticSchema,
    targetDoc: firestore_1.documentReferenceSchema.optional(),
}));
exports.threadSchema = yup.object({
    ...
    aiSuggestionsById: exports.aiSuggestionsById.optional(),
