...
exports.issueSchema = yup.object().shape({
    ...
    recommendedSupportGroups: yup.array().of(firestore_1.documentReferenceSchema.required()),
    ...
    supportGroupOrdinals: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
