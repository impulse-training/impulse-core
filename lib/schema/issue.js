...
exports.issueSchema = yup.object().shape({
    ...
    questionTactic: tactic_1.questionTacticSchema,
    ...
    // Recommendations
    impulseStrategies: yup.array().of(strategy_1.impulseStrategySchema),
    scheduledStrategies: yup.array(strategy_1.timeStrategySchema).required(),
    locationStrategies: yup.array(strategy_1.locationStrategySchema).required(),
});
