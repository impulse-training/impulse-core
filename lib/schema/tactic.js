...
function tacticValueBaseSchema(type) {
    return yup.object({
        ...
        impulseOrdinals: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
        debriefOrdinals: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
        emotionOrdinals: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
        scheduledMinuteOrdinals: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
        scheduledLocationOrdinals: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
    });
}
