...
exports.isQuestionTactic = exports.isTaskTactic = exports.isOptionsTactic = exports.isBreatheTactic = exports.isPhoneTacticValue = exports.isMeasureCounterTactic = exports.isMeasureTimeTactic = exports.isMeasureSliderTactic = exports.isVideoTactic = exports.isAudioTactic = exports.isEmotionsTactic = exports.isStepsTactic = exports.tacticColors = exports.tacticSchemas = exports.tacticSchema = exports.questionTacticSchema = exports.taskTacticSchema = exports.optionsTacticSchema = exports.urgeSurfingTacticSchema = exports.breatheTacticSchema = exports.phoneTacticSchema = exports.measureCounterTacticSchema = exports.measureTimeTacticSchema = exports.measureSliderTacticSchema = exports.videoTacticSchema = exports.audioTacticSchema = exports.emotionsTacticSchema = exports.stepsTacticSchema = void 0;
...
exports.optionsTacticSchema = tacticValueBaseSchema('options').shape({
...
exports.tacticSchema = yup.lazy(value => {
    switch (value.type) {
        case 'phone':
            return exports.phoneTacticSchema;
        case 'audio':
            return exports.audioTacticSchema;
        case 'video':
            return exports.videoTacticSchema;
        case 'question':
            return exports.questionTacticSchema;
        case 'measure-slider':
            return exports.measureSliderTacticSchema;
        case 'measure-time':
            return exports.measureTimeTacticSchema;
        case 'measure-counter':
            return exports.measureCounterTacticSchema;
        case 'options':
            return exports.optionsTacticSchema;
        case 'breathe':
            return exports.breatheTacticSchema;
        case 'steps':
            return exports.stepsTacticSchema;
        case 'emotions':
            return exports.emotionsTacticSchema;
        case 'task':
            return exports.taskTacticSchema;
        default:
...
exports.tacticSchemas = {
    ...
    options: exports.optionsTacticSchema,
