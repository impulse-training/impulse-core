...
function tacticValueBaseSchema(type) {
    return yup.object({
        ...
        ordinals: yup.object({
            main: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
            impulseDebrief: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
            routine: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
            tactic: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
        }),
    });
}
