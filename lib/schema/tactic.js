...
function tacticValueBaseSchema(type) {
    return yup.object({
        ...
        ordinals: yup.object({
            impulse: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
            debrief: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
            emotion: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
            scheduledGameplan: (0, objectOf_1.optionalObjectOf)(yup.number().required()),
        }),
    });
}
