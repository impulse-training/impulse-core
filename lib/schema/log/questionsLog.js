...
exports.questionsLogSchema = (0, base_1.logBaseSchema)('questions').shape(Object.assign({ questionsById: (0, objectOf_1.objectOf)(question_1.questionSchema), questionData: (0, objectOf_1.optionalObjectOf)(exports.questionDataSchema), submittedAt: timestamp_1.optionalTimestampSchema, trackingQuestionIds: array_1.optionalStringArray, debriefingQuestionIds: array_1.optionalStringArray, isDebrief: yup.boolean(), followedUpQuestionIds: array_1.optionalStringArray }, gpt_1.gptResponseMixin));
