...
exports.tacticsLogSchema = (0, base_1.logBaseSchema)('tactics').shape(Object.assign({ title: yup.string(), 
    ...
    isAddToGameplanMode: yup.boolean(), suggestedStrategyDocPaths: array_1.optionalStringArray, tacticsById: (0, objectOf_1.objectOf)(tactic_1.tacticSchema), 
