...
export type LogValue = AudioLogValue | ImpulseLogValue | MessageLogValue | QuestionsLogValue | ActionRecapLogValue | StrategiesLogValue | ShowTourLogValue | DayReviewLogValue | WhatsappMessageLogValue;
