...
function logBaseSchema(type) {
    return yup.object(Object.assign({ createdAt: timestamp_1.optionalTimestampSchema, updatedAt: timestamp_1.optionalTimestampSchema, text: yup.string(), type: yup.mixed().oneOf([type]).defined(), date: timestamp_1.timestampSchema, tacticId: yup.string().nullable(), 
