...
function logBaseSchema(type) {
    return yup.object(Object.assign({ createdAt: timestamp_1.optionalTimestampSchema, updatedAt: timestamp_1.optionalTimestampSchema, type: yup.mixed().oneOf([type]).defined(), date: timestamp_1.timestampSchema, senderProfileId: yup.string().nullable(), views: yup.array().of(logViewSchema), gptPayload: yup.array().of(gpt_1.gptMessageSchema) }, gpt_1.gptResponseMixin));
}
