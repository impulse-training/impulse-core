...
const baseLogSchema = yup.object().shape({
    ...
    strategyIds: array_1.requiredStringArray,
    seenTacticsById: (0, objectOf_1.objectOf)(tactic_1.tacticSchema),
...
const impulseLogSchema = baseLogSchema.concat(yup.object().shape({
    ...
    strategiesByPatternId: (0, objectOf_1.objectOf)(strategy_1.strategySchema),
