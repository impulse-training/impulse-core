...
const baseLogSchema = yup.object().shape({
    ...
    questions: yup.array().of(exports.questionSchema.required()).required(),
    ...
    tacticsById: tactic_1.tacticInfoWithStrategySchema,
    tacticLikes: (0, objectOf_1.optionalObjectOf)(yup.boolean().required()),
    tacticData: (0, objectOf_1.objectOf)(exports.tacticDataSchema),
    supportGroups: yup.array().of(firestore_1.documentReferenceSchema.required()).required(),
});
