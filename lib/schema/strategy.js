...
exports.strategySchemas = Object.assign(Object.assign({}, tactic_1.tacticSchemas), { folder: folder_1.folderSchema, defaultFor: yup.mixed().oneOf(['profile']), 
    // And recommendations are suggested to users based on their issue (addiction, rumination, etc.)
    recommendedFor: yup.mixed().oneOf(['profile']).nullable() });
