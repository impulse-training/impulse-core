...
exports.logIsButtonLog = exports.logIsMotionLog = exports.logIsDebriefLog = exports.logIsTimeLog = exports.logIsLocationLog = exports.logIsImpulseLog = void 0;
...
const BaseLogValueSchema = yup.object().shape({
    ...
    gameplan: yup.object().shape({
        main: yup.mixed().required(),
        success: yup.mixed().notRequired(),
        setback: yup.mixed().notRequired(), // Replace with GameplanSchema if defined
    }),
    tactics: yup.object().shape({}).required(),
