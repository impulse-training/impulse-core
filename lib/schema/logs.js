...
const BaseLogSchema = yup.object().shape({
    ...
    gameplan: yup.object().shape({
        main: gameplan_1.gameplanBaseSchema.required(),
        success: gameplan_1.gameplanBaseSchema.notRequired(),
        setback: gameplan_1.gameplanBaseSchema.notRequired(),
    }),
    tactics: yup
        .object()
        .shape({
...
const impulseLogSchema = BaseLogSchema.concat(yup.object().shape({
    ...
    patterns: yup
        .object()
        .shape({
        [yup.ref('$placeholderKey')]: pattern_1.patternSchema,
    })
        .required(),
