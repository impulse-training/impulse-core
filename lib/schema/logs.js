...
exports.logSchema = exports.logIsButtonLog = exports.logIsMotionLog = exports.logIsTimeLog = exports.logIsLocationLog = exports.logIsImpulseLog = exports.tacticDataSchema = void 0;
...
const baseLogSchema = yup.object().shape({
    ...
    // later.
    strategy: yup.object({
        main: gameplan_1.strategySchema.required(),
        measure: gameplan_1.strategySchema.notRequired(),
        success: gameplan_1.strategySchema.notRequired(),
        setback: gameplan_1.strategySchema.notRequired(),
    }),
    seenStrategy: (0, objectOf_1.objectOf)(array_1.requiredStringArray),
...
const impulseLogSchema = baseLogSchema.concat(yup.object().shape({
    ...
    outcome: yup.mixed().oneOf(['success', 'setback']),
