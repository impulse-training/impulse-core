...
exports.logValueSchema = exports.logIsButtonLog = exports.logIsMotionLog = exports.logIsDebriefLog = exports.logIsTimeLog = exports.logIsLocationLog = exports.logIsImpulseLog = void 0;
...
const BaseLogValueSchema = yup.object().shape({
    ...
    gameplan: yup.object().shape({
        main: gameplan_1.gameplanSchema.required(),
        success: gameplan_1.gameplanSchema.notRequired(),
        setback: gameplan_1.gameplanSchema.notRequired(),
    }),
    tactics: yup
        .object()
        .shape({
    ...
    supportGroupSuggestedTacticIds: yup
        .object()
        .shape({
        impulse: yup.object().shape({}).required(),
        success: yup.object().shape({}).required(),
        setback: yup.object().shape({}).required(),
...
const impulseLogValueSchema = BaseLogValueSchema.concat(yup.object().shape({
    ...
    gameplans: yup.object().shape({}).required(),
    patterns: yup
        .object()
        .shape({
        [yup.ref('$placeholderKey')]: pattern_1.patternValueSchema,
    })
        .required(),
    ...
    {
        [yup.ref('$placeholderKey')]: pattern_1.patternUsageSchema,
    })
        .required()
        .noUnknown(),
...
const locationLogValueSchema = BaseLogValueSchema.concat(yup.object().shape({
...
const timeLogValueSchema = BaseLogValueSchema.concat(yup.object().shape({
...
const debriefLogValueSchema = BaseLogValueSchema.concat(yup.object().shape({
...
const motionLogValueSchema = BaseLogValueSchema.concat(yup.object().shape({
