...
exports.logSchema = exports.logIsButtonLog = exports.logIsMotionLog = exports.logIsDebriefLog = exports.logIsTimeLog = exports.logIsLocationLog = exports.logIsImpulseLog = exports.tacticDataSchema = void 0;
...
const baseLogSchema = yup.object().shape({
    ...
    commentsByTacticId: (0, objectOf_1.optionalObjectOf)(yup.object().shape({
        ...
        comments: yup.array().of(comment_1.commentSchema.required()).required(),
    })),
