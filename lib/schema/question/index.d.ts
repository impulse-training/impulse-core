...
import { QuestionIssueValue } from './issue';
...
export type QuestionValue = QuestionTextValue | QuestionScaleOf1To10Value | QuestionTimeValue | QuestionCounterValue | QuestionMultipleChoiceValue | QuestionIssueValue;
