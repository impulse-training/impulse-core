...
function logTextForGpt(log) {
    ...
    if (log.behaviorData) {
        const behaviorsDescription = (0, lodash_1.compact)((0, lodash_1.flatMap)(log.behaviorsById, (behavior, behaviorId) => {
            var _a;
            const prompt = behavior.prompt;
            const userAnswer = (_a = log.behaviorData) === null || _a === void 0 ? void 0 : _a[behaviorId];
