...
const logs_1 = require("../../factories/logs");
...
describe('Challenge', () => {
    describe('processLog', () => {
        ...
        const challengeData = challenge_1.challengeFactory.build({
            type: 'setbacks',
            days: 4,
        ...
        const challenge = new challenge_2.Challenge('id', challengeData, FakeTimestamp_1.FakeTimestamp);
        ...
        describe('with an ineligible log', () => {
            const log = logs_1.tacticsLogFactory.build({
                uid,
                createdAt: { toDate: () => date },
                startTime: { toDate: () => date },
            });
    ...
    describe('name', () => {
        it('returns the right name for a button challenge with multiple days', () => {
            const challenge = new challenge_2.Challenge('id', challenge_1.challengeFactory.build({
                type: 'button',
                days: 4,
            }), FakeTimestamp_1.FakeTimestamp);
