...
describe('Routine classes', () => {
    ...
    describe('TimeRoutine', () => {
        describe('summary', () => {
            it('should return null if weekdays array is empty', () => {
                const routine = new routine_1.TimeRoutine('1', {
                    uid,
                    createdAt: new Date(),
                    updatedAt: new Date(),
            ...
            it('should return the correct summary for specific weekdays', () => {
                ...
                expect(routine.summary).toBe('Sundays, Tuesdays, and Thursdays at 12:00 PM');
            });
            it('should return the correct summary for specific weekdays', () => {
                const routine = new routine_1.TimeRoutine('1', {
                    uid,
    ...
    describe('LocationRoutine', () => {
        it('should return the correct summary', () => {
            const routine = new routine_1.LocationRoutine('1', {
                uid,
                createdAt: new Date(),
                updatedAt: new Date(),
                type: 'location',
