...
exports.gameplanToClass = exports.ImpulseGameplan = exports.LocationGameplan = exports.DayDebriefGameplan = exports.TimeGameplan = exports.SHORT_DAYS = void 0;
...
class DayDebriefGameplan extends Gameplan {
    constructor(id, data) {
        super();
        this.id = id;
        this.data = data;
...
exports.DayDebriefGameplan = DayDebriefGameplan;
DayDebriefGameplan.DAYS = exports.SHORT_DAYS;
...
class ImpulseGameplan extends Gameplan {
    ...
    get summary() {
        if (this.data.type === 'impulseDebrief')
            return 'Debriefing';
...
function gameplanToClass(id, gameplan, location) {
    if (gameplan.type === 'time') {
        ...
        return new DayDebriefGameplan(id, gameplan);
    }
