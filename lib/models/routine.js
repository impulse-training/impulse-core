...
exports.timeStrategySchemaSummary = void 0;
const lodash_1 = require("lodash");
const days_1 = require("../utils/days");
function timeStrategySchemaSummary(routine) {
    var _a;
    if (!((_a = routine.weekdays) === null || _a === void 0 ? void 0 : _a.length))
        return '';
    const weekdays = routine.weekdays.sort();
    const weekdayNames = weekdays.map(dayNumber => days_1.LONG_DAYS[dayNumber]);
    function getDaysDescription() {
        ...
        if (weekdays.length === 6) {
            ...
            return `Daily except ${days_1.LONG_DAYS[missingDay]}`;
        }
...
exports.timeStrategySchemaSummary = timeStrategySchemaSummary;
