...
export declare const makeNewGameplanRecommendationRuleFactory: (TimestampKlass: typeof TimestampLike) => Factory.Sync.Factory<RecommendationRuleValue, keyof RecommendationRuleValue>;
