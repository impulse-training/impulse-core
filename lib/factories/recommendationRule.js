...
exports.makeTimeRecommendationRuleFactory = exports.makeImpulseDebriefRecommendationRuleFactory = exports.makeImpulseRecommendationRuleFactory = void 0;
...
const makeTimeRecommendationRuleFactory = (TimestampKlass) => Factory.makeFactory({
    createdAt: TimestampKlass.now(),
    updatedAt: TimestampKlass.now(),
    type: 'time',
    uid: Factory.each(i => `impulse-debrief-recommendation-rule-${i}`),
    recommendation: (0, recommendation_1.makeTimeRecommendationFactory)(TimestampKlass).build(),
    forIssueIds: [],
    ordinal: 0,
});
exports.makeTimeRecommendationRuleFactory = makeTimeRecommendationRuleFactory;
