...
exports.makeMeasureTimeTacticFactory = exports.makeFolderTacticFactory = exports.makeTacticFactory = void 0;
...
const makeFolderTacticFactory = (TimestampKlass) => Factory.makeFactory({
    profileId: Factory.each(i => i.toString()),
    type: 'folder',
    title: 'Get moving',
    description: "Sometimes you just need to let it out! Find a private spot (we don't want any distractions!) and scream your heart out. Feel the wind in your hair, the rush of adrenaline, and the release of built-up tension. Let your voice fill the space around you and leave all your worries behind. Don't worry about being too loud, let your inner rockstar shine! Just remember, it's not a permanent solution - once you're ready, come on back and let's find some other ways to cope.",
    ...
    backgroundColor: '#FF0000',
    tacticIds: ['abc'],
    tacticsById: { abc: (0, exports.makeTacticFactory)(TimestampKlass).build() },
    currentTacticIndex: 0,
    autogenerate: false,
});
exports.makeFolderTacticFactory = makeFolderTacticFactory;
const makeMeasureTimeTacticFactory = (TimestampKlass) => Factory.makeFactory({
    profileId: Factory.each(i => i.toString()),
    type: 'measure-time',
...
exports.makeMeasureTimeTacticFactory = makeMeasureTimeTacticFactory;
