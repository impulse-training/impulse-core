...
exports.makeNewGameplanRecommendationRuleFactory = exports.makeRecommendationRuleFactory = void 0;
...
const makeNewGameplanRecommendationRuleFactory = (TimestampKlass) => Factory.makeFactory({
    uid: Factory.each(i => i.toString()),
    createdAt: TimestampKlass.now(),
    updatedAt: TimestampKlass.now(),
    // For now, we need to specify recommendation properties manually, instead of deferring to the
...
exports.makeNewGameplanRecommendationRuleFactory = makeNewGameplanRecommendationRuleFactory;
