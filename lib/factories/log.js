...
exports.makeLocationLogFactory = exports.makeMotionLogFactory = exports.makeRecapLogFactory = exports.makeTimeLogFactory = exports.makeImpulseFactory = void 0;
...
const makeRecapLogFactory = (TimestampKlass) => Factory.makeFactory({
    uid: Factory.each(i => i.toString()),
    type: 'recap',
    createdAt: TimestampKlass.now(),
    updatedAt: TimestampKlass.now(),
...
exports.makeRecapLogFactory = makeRecapLogFactory;
