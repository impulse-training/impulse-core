...
function makeFactories(TimestampKlass) {
    return {
        ...
        recapLogFactory: (0, log_1.makeRecapLogFactory)(TimestampKlass),
        ...
        impulseDebriefRecommendationRuleFactory: (0, recommendationRule_1.makeImpulseDebriefRecommendationRuleFactory)(TimestampKlass),
        timeRecommendationRuleFactory: (0, recommendationRule_1.makeTimeRecommendationRuleFactory)(TimestampKlass),
        tacticFactory: (0, tactic_1.makeTacticFactory)(TimestampKlass),
        measureTimeTacticFactory: (0, tactic_1.makeMeasureTimeTacticFactory)(TimestampKlass),
