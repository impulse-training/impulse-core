...
exports.tacticFactory = exports.supportGroupFactory = exports.profileFactory = exports.debriefGameplanFactory = exports.logSummaryFactory = exports.debriefLogFactory = exports.motionLogFactory = exports.timeLogFactory = exports.impulseFactory = exports.commentFactory = exports.challengeFactory = exports.applicationFactory = exports.makeFactories = void 0;
...
function makeFactories(TimestampKlass) {
    return {
        ...
        patternGameplanFactory: (0, gameplan_1.makeImpulseGameplanFactory)(TimestampKlass),
...
// library
_a = makeFactories(FakeTimestamp_1.FakeTimestamp), exports.applicationFactory = _a.applicationFactory, exports.challengeFactory = _a.challengeFactory, exports.commentFactory = _a.commentFactory, exports.impulseFactory = _a.impulseFactory, exports.timeLogFactory = _a.timeLogFactory, exports.motionLogFactory = _a.motionLogFactory, exports.debriefLogFactory = _a.debriefLogFactory, exports.logSummaryFactory = _a.logSummaryFactory, exports.debriefGameplanFactory = _a.debriefGameplanFactory, exports.profileFactory = _a.profileFactory, exports.supportGroupFactory = _a.supportGroupFactory, exports.tacticFactory = _a.tacticFactory;
