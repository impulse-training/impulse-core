...
const makeProfileSupportGroup_1 = require("./makeProfileSupportGroup");
...
function makeFactories(TimestampKlass) {
    return {
        ...
        profileLogsSummaryFactory: profileLogsSummary_1.profileLogsSummaryFactory,
        ...
        profileSupportGroupFactory: (0, makeProfileSupportGroup_1.makeProfileSupportGroupFactory)(TimestampKlass),
        ...
        strategyFactory: (0, strategy_1.makeStrategyFactory)(TimestampKlass),
