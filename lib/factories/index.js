...
function makeFactories(TimestampKlass) {
    return {
        ...
        folderStrategyFactory: (0, strategy_1.makeFolderStrategyFactory)(TimestampKlass),
        tacticStrategyFactory: (0, strategy_1.makeTacticStrategyFactory)(TimestampKlass),
