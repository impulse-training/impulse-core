...
exports.tagFactory = exports.tacticFactory = exports.supportGroupFactory = exports.profileFactory = exports.logSummaryFactory = exports.motionLogFactory = exports.timeLogFactory = exports.tacticsLogFactory = exports.impulseFactory = exports.challengeFactory = exports.applicationFactory = exports.makeFactories = void 0;
...
function makeFactories(TimestampKlass) {
    return {
        ...
        tacticsLogFactory: (0, logs_1.makeTacticsLogFactory)(TimestampKlass),
        ...
        timeReminderFactory: (0, reminder_1.makeTimeReminderFactory)(TimestampKlass),
        patternFactory: (0, pattern_1.makePatternFactory)(TimestampKlass),
        locationReminderFactory: (0, reminder_1.makeLocationReminderFactory)(TimestampKlass),
        tacticFactory: (0, tactic_1.makeTacticFactory)(TimestampKlass),
        tagFactory: (0, tag_1.makeTagFactory)(TimestampKlass),
    };
}
...
// library
_a = makeFactories(FakeTimestamp_1.FakeTimestamp), exports.applicationFactory = _a.applicationFactory, exports.challengeFactory = _a.challengeFactory, exports.impulseFactory = _a.impulseFactory, exports.tacticsLogFactory = _a.tacticsLogFactory, exports.timeLogFactory = _a.timeLogFactory, exports.motionLogFactory = _a.motionLogFactory, exports.logSummaryFactory = _a.logSummaryFactory, exports.profileFactory = _a.profileFactory, exports.supportGroupFactory = _a.supportGroupFactory, exports.tacticFactory = _a.tacticFactory, exports.tagFactory = _a.tagFactory;
