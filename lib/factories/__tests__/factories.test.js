...
const schemaMap = {
    ...
    debriefLogFactory: schema_1.logSchema,
    ...
    impulseRecommendationFactory: schema_1.recommendationSchema,
    impulseRecommendationRuleFactory: schema_1.impulseRecommendationRuleSchema,
    impulseDebriefRecommendationRuleFactory: schema_1.impulseDebriefRecommendationRuleSchema,
    timeRecommendationRuleFactory: schema_1.timeRecommendationRuleSchema,
