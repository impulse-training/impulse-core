...
const schemaMap = {
    ...
    messageLogFactory: schema_1.logSchema,
    strategiesLogFactory: schema_1.logSchema,
    questionsLogFactory: schema_1.logSchema,
    locationFactory: null,
    profileFactory: null,
    issueFactory: null,
    dayReviewThreadFactory: schema_1.threadSchema,
    folderFactory: schema_1.folderSchema,
    tacticFactory: schema_1.tacticSchema,
    timeQuestionFactory: question_1.questionSchema,
    textQuestionFactory: question_1.questionSchema,
    multipleChoiceQuestionFactory: question_1.questionSchema,
